...
// Вопрос про правила
lobby.add(['^как игра..', '^правила', 'какие правила игры'], ctx => {
...
lobby.add(['^готов$', '^играть', '-^как игра..', '^начина', 'поехали', '^могу', 'давай'], enterInGame);
lobby.add(['+^да$', '-^нет$', '-может'], enterInGame);
lobby.add(['+почему бы и нет$', '-может'], enterInGame);
